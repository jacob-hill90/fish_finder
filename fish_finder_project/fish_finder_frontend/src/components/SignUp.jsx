                                    ...
                                    <form onSubmit={formik.handleSubmit} className="p-fluid">
                                        <div className="field">
                                            <span className="p-float-label">
                                                <InputText id="first_name" name="first_name" value={formik.values.first_name} onChange={formik.handleChange} onBlur={formik.handleBlur} autoFocus className={classNames({ 'input-error': isFormFieldValid('first_name') })} />
                                        ...
                                        <div className="field">
                                            <span className="p-float-label">
                                                <InputText id="last_name" name="last_name" value={formik.values.last_name} onChange={formik.handleChange} onBlur={formik.handleBlur} autoFocus className={classNames({ 'input-error': isFormFieldValid('last_name') })} />
                                        ...
                                        <div className="field">
                                            <span className="p-float-label">
                                                <InputText id="username" name="username" value={formik.values.username} onChange={formik.handleChange} onBlur={formik.handleBlur} autoFocus className={classNames({ 'input-error': isFormFieldValid('username') })} />
                                        ...
                                        <div className="field">
                                            <span className="p-float-label">
                                                <InputText id="zipcode" name="zipcode" value={formik.values.zipcode} onChange={formik.handleChange} onBlur={formik.handleBlur} autoFocus className={classNames({ 'input-error': isFormFieldValid('zipcode') })} />
                                        ...
                                        <div className="field">
                                            <span className="p-float-label">
                                                <Dropdown id="state" name="state" value={formik.values.state} onChange={formik.handleChange} onBlur={formik.handleBlur} options={stateSelectItems} optionValue="value" optionLabel="label" autoFocus className={classNames({ 'p-invalid': isFormFieldValid('state') })} />
                                                <label htmlFor="state" className={classNames({ 'input-error': isFormFieldValid('state') })}>State*</label>
                                            </span>
