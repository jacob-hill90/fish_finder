    ...
    <div className='bg-image'>
      ...
      <div className="about">
        ...
        <div className="about-points">
          <h5>Whether you are an angling amateur or a seasoned pro, Fishtories provides you with the tools and information you need to perform exceptionally every time you hit the water.</h5>
        </div>
      </div>
    </div>
  );
